...
class BitcoinCryptographyTests extends FlatSpec with Matchers{

  "Bitcoin addresses" should "be derived correctly from public keys" in {
    ...
    Parsec.bitcoinAddressFromPublicKey(publicKey) should be (address)
  }
}